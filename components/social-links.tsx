...
export const SOCIAL_LINKS = [
  { label: "github", href: "https://github.com/BlitzJB", Icon: GitHubIcon },
  {
    label: "linkedin",
...
export function SocialLinks({
  ...
  return (
    <div
      className={cn("flex flex-wrap items-center font-mono", className)}
      {...props}
    >
      {SOCIAL_LINKS.map(({ label, href, Icon }) => (
        <a
          ...
          {...(href.startsWith("http")
            ...
            : {})}
          className="inline-flex items-center gap-1.5 text-ink-faint transition-colors hover:text-accent-ink"
        >
