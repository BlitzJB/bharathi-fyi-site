...
tags:
  ...
  - simulation
  - hackathon-winner
resource: https://github.com/BlitzJB/KHackSim
status: stable
generated:
  by: claude-fable/5
...
A realistic car physics simulator for vehicle **fleets**, built for fleet
infrastructure testing. It runs a real-time simulation of **1000+ cars**
using CARLA as the world simulator, with high-accuracy physics models and an
...
Next.js, CARLA, Python, MATLAB, physics modeling.
