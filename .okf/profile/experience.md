...
description: Role-by-role record of Bharathi's professional experience.
tags:
  - profile
  - experience
status: stable
...
- **Event queue platform modernization**: evaluated and benchmarked Apache
  ...
  agnostic across Azure Event Hubs, Kafka, and Pulsar; led a **zero-downtime
  migration** of the customer-facing API backend onto EQA, with comprehensive
  testing and cross-team coordination.
- **Multi-tenant monitoring framework**: migrated cron-based monitoring to
  **VictoriaMetrics alerts**; built a code-generation framework for
...
- Spearheaded development of the company's **main app in React Native**,
...
- Built traffic-bearing backends for public-facing applications (e-commerce)
  ...
  fleet management.
- Designed and shipped frontends that measurably boosted sales and enquiries
  for **20+ clients across India**.
...
- [about](/profile/about.md), [journey](/profile/journey.md), [awards](/profile/awards.md)
