...
- **Platform & backend**: event streaming (Apache Pulsar, Kafka, Azure Event Hubs), monitoring (VictoriaMetrics), GitOps pipelines, Postgres, Express, Flask, Django
- **AI & ML**: PyTorch, TensorFlow, LLM application development (course-generation platforms, simulation tooling)
- **Frontend & product**: React, Next.js, React Native, Three.js, Figma (UI/UX)
- **Cloud**: GCP, Azure
...
- The career arc: [journey](/profile/journey.md)
- Role-by-role detail: [experience](/profile/experience.md)
- Competition record: [awards](/profile/awards.md)
- Selected work: [projects](/projects/index.md)

[^resume-2025]: Education, roles, and skills are drawn from Bharathi's résumé; the résumé predates his current AI-focused work.
